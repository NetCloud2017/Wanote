...
| hab hibit habit 拿着 | hum ⼈类 泥⼟ 潮湿 | hor 害怕 |
| :------------------- | :----------------: | -------: |
| habitat, inhabit     |    human, humid    | horrible |

# I

| it ⾛       | isol insul 孤⽴的 | infra- 下,在下 |
| :---------- | :---------------: | -------------: |
| exit, visit |  island, isolate  | infrastructure |

---

# J

| ject jet jac 扔  | just jud judg jur 公平 公正 | join junct jug 加⼊ |
| :--------------- | :-------------------------: | ------------------: |
| **jet**, project |       adjudge, injury       |   join, conjunction |
...
dispose, component, compound

> point punct 点 针 指⽰

pointless, acupuncture
...
police, singapore, policy

> press 压

press, pressure, compress
...
price, praise, appraise

> ped pod pus 脚

octopus, October, pedestrian
...
second, sequence, execute, aspect

> serv 服务 保护

slave, serve, conserve
...
sit, seat, settle, president

> st sta stan stin stab stor stat stit stitut sist 站

stand, station, store, storage, institute

> sist 帮助

sister, assist, consist
...
sting, ticket, lipstick, steak

> sign 记号

sock, sign, signal, resign

> sper spir 精神, 呼吸

Sprite, spirit, aspire, expire

> str strain strict stress 拖 拉 拽

district, strain, street
...
tin, contain, entertain

> text 编 编织

toilet water, text, textile
...
street, track, truck, tractor

> tact tang ting tig tag 接触

tango, contact, contagion
...
window, prevent, invent

> via vi voy vey 路

away, noway, via, voyage

> van vac vacu vain void wan 空

void, van, vanguard, advantage
...
viagra, vivid, survive, vitamin

> voc vok 声⾳

voice, advocate, vocabulary
